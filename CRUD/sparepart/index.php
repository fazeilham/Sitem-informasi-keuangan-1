...
<div class="container py-4">
    ...
    <?php if (isset($_GET['msg'])): ?>
        <div class="alert alert-success alert-dismissible fade show">
            Sparepart berhasil <?= $_GET['msg'] == 'tambah' ? 'ditambahkan' : ($_GET['msg'] == 'edit' ? 'diperbarui' : 'dihapus') ?>.
                ...
                <?php $no = 1; while ($row = mysqli_fetch_assoc($sparepart)): ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="index.php?hapus=<?= $row['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Hapus sparepart ini?')"><i class="bi bi-trash"></i> Hapus</a>
                        </td>
                    </tr>
                <?php endwhile; ?>
                </tbody>
