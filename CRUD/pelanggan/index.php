                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="kendaraan.php?pelanggan_id=<?= $row['id'] ?>"
                                    class="btn btn-info btn-sm text-white"><i class="bi bi-truck"></i> Kendaraan</a>
                                <a href="edit.php?id=<?= $row['id'] ?>" class="btn btn-warning btn-sm"><i
                                        class="bi bi-pencil"></i> Edit</a>
                                <a href="index.php?hapus=<?= $row['id'] ?>" class="btn btn-danger btn-sm"
                                    onclick="return confirm('Yakin hapus pelanggan ini?')"><i class="bi bi-trash"></i>
                                    Hapus</a>
                            </td>
                        </tr>
                        <?php endwhile; ?>
