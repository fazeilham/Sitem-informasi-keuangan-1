...
// Ambil bulan dan tahun dari parameter atau gunakan bulan ini
...
$bulan_display = date('F Y', strtotime($tanggal_awal));
?>
<!DOCTYPE html>
<html lang="id">
...
<head>
    ...
    <title>Laporan Bulanan - Bengkel Biyai Racing Shop</title>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="laporan_harian.php"><i class="bi bi-calendar-day"></i>
                                    Laporan Harian</a></li>
                            <li><a class="dropdown-item" href="laporan_mingguan.php"><i class="bi bi-calendar-week"></i>
                                    Laporan Mingguan</a></li>
                            <li><a class="dropdown-item active" href="laporan_bulanan.php"><i
    ...
    <div class="container main-container">
        ...
        <div class="header-section">
            <div class="d-flex justify-content-between align-items-center flex-wrap">
                <div>
                    <h1 class="mb-2">
                        <i class="bi bi-calendar-month text-danger"></i> Laporan Bulanan
                    </h1>
                    <p class="text-muted mb-0">Laporan transaksi keuangan per bulan</p>
                </div>
                <div class="d-flex gap-2 flex-wrap mt-3 mt-md-0">
                    ...
                    <a href="cetak_pdf.php?type=bulanan&bulan=<?php echo $bulan; ?>" target="_blank"
                        class="btn btn-print">
        ...
        <div class="card mb-4" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white;">
            <div class="card-body text-center">
                <h4 class="mb-0">
                    <i class="bi bi-calendar3"></i> Bulan: <?php echo $bulan_display; ?>
                </h4>
            </div>
        </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td colspan="8" class="text-center py-5">
                                    ...
                                    <p class="mt-3 text-muted">Tidak ada transaksi pada bulan ini</p>
                                </td>
                            </tr>
                            <?php
                            }
