...
<head>
    ...
    <title>Laporan Harian - Bengkel Biyai Racing Shop</title>
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item active" href="laporan_harian.php"><i
    ...
    <div class="container main-container">
        ...
        <div class="header-section">
            <div class="d-flex justify-content-between align-items-center flex-wrap">
                <div>
                    <h1 class="mb-2">
                        <i class="bi bi-calendar-day text-danger"></i> Laporan Harian
                    </h1>
                    <p class="text-muted mb-0">Laporan transaksi keuangan per hari</p>
                </div>
                <div class="d-flex gap-2 flex-wrap mt-3 mt-md-0">
                    ...
                    <a href="cetak_pdf.php?type=harian&tanggal=<?php echo $tanggal; ?>" target="_blank"
                        class="btn btn-print">
        ...
        <div class="card mb-4" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white;">
            <div class="card-body text-center">
                <h4 class="mb-0">
                    <i class="bi bi-calendar3"></i> Tanggal: <?php echo $tanggal_display; ?>
                </h4>
            </div>
        </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td colspan="8" class="text-center py-5">
                                    ...
                                    <p class="mt-3 text-muted">Tidak ada transaksi pada tanggal ini</p>
                                </td>
                            </tr>
                            <?php
                            }
